  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            ...
            <se:Stroke>
              ...
              <se:SvgParameter name="stroke-opacity">0.14</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>15 - 29</se:Name>
          <se:Description>
            <se:Title>15 - 29</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
        ...
        <se:Rule>
          <se:Name>29 - 55</se:Name>
          <se:Description>
            <se:Title>29 - 55</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>55 - 123</se:Name>
          <se:Description>
            <se:Title>55 - 123</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>123 - 34005</se:Name>
          <se:Description>
            <se:Title>123 - 34005</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
