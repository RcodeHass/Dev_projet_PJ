...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>0 - 3,3</se:Name>
          <se:Description>
            <se:Title>0 - 3,3</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>part_fmp</ogc:PropertyName>
                <ogc:Literal>0</ogc:Literal>
              </ogc:PropertyIsGreaterThanOrEqualTo>
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>part_fmp</ogc:PropertyName>
                <ogc:Literal>3.33333333333332993</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            ...
            <se:Stroke>
              ...
              <se:SvgParameter name="stroke-opacity">0.035</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>3,3 - 8,8</se:Name>
          <se:Description>
            <se:Title>3,3 - 8,8</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>part_fmp</ogc:PropertyName>
                <ogc:Literal>8.79750130140551967</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>
          <se:Name>8,8 - 15</se:Name>
          <se:Description>
            <se:Title>8,8 - 15</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>part_fmp</ogc:PropertyName>
                <ogc:Literal>15.03759398496240074</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>
          <se:Name>15 - 29,4</se:Name>
          <se:Description>
            <se:Title>15 - 29,4</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>part_fmp</ogc:PropertyName>
                <ogc:Literal>29.41176470588240122</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>
          <se:Name>29,4 - 100</se:Name>
          <se:Description>
            <se:Title>29,4 - 100</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
