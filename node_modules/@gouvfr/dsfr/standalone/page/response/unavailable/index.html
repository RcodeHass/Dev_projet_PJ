            ...
            <div class="fr-grid-row fr-grid-row--center fr-grid-row--gutters">
                <div class="fr-server__body fr-col-12 fr-col-md-6">
                    ...
                    <ul class="fr-btns-group fr-btns-group--inline fr-btns-group--sm">
                        <li>
                            <a href="[À MODIFIER - https://facebook.com/]" class="fr-btn fr-btn--tertiary">
                        ...
                        <li>
                            <a href="[À MODIFIER - https://twitter.com/]" class="fr-btn fr-btn--tertiary">
                                <span aria-hidden="true">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        ...
                        <li>
                            <a href="[À MODIFIER - https://linkedin.com/]" class="fr-btn fr-btn--tertiary">
                                <span aria-hidden="true">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
