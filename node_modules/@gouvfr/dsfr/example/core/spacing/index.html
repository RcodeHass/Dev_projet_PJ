...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <button type="button" class="fr-px-4v fr-px-md-16v fr-btn">4v en mobile / 16v en md</button>
            </div>
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-73">Extrait de code</button>
                    </h3>
                    <div id="snippet-73" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;button type="button" class="fr-px-4v fr-px-md-16v fr-btn fr-btn"&gt;4v en mobile / 16v en md&lt;/button&gt;
</code></pre>
                    </div>
                </section>
            </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-74" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
