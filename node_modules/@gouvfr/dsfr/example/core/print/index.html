...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>no-print (cache pour l&#39;impression)</h3>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-61">Extrait de code</button>
                    </h3>
                    <div id="snippet-61" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-no-print"&gt;
    &lt;p&gt;Lorem [...] elit ut.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-62" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
