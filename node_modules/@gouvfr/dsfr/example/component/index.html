...
<head>
    ...
    <title>Composant - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container">
        <ul class="fr-col-12">
            ...
            <li class="fr-mb-1w">
                <a href='./notice/'>Bandeau d&#39;information importante (notice)</a>
            </li>
            <li class="fr-mb-1w">
            ...
            <li class="fr-mb-1w">
                <a href='./content/'>Contenu médias (content)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./segmented/'>Contrôle segmenté (segmented)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./range/'>Curseur (range)</a>
            </li>
            <li class="fr-mb-1w">
            ...
            <li class="fr-mb-1w">
                <a href='./tooltip/'>Information contextuelle et Infobulle (tooltip)</a>
            </li>
            <li class="fr-mb-1w">
            ...
            <li class="fr-mb-1w">
                <a href='./input/'>Champ de saisie (input)</a>
            </li>
        </ul>
    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-934" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
