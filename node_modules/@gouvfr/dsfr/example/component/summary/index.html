...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/sommaire" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                            ...
                            <ol>
                                ...
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            <a class="fr-summary__link" id="summary-link-3-2" href="#anchor-3.2">Libellé du lien 3.2</a>
                                        </li>
                                    </ol>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            <a class="fr-summary__link" id="summary-link-13-8" href="#anchor-13.8">Libellé du lien 13.8</a>
                                        </li>
                                        <li>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7154">Extrait de code</button>
                            </h3>
                            <div id="snippet-7154" class="fr-collapse">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7155" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
