...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/curseur" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-range-group" id="range-2096-group">
                            ...
                            <div class="fr-range">
                                ...
                                <input id="range-2095" name="range-2095" type="range" aria-labelledby="range-2095-label" max="100" value="50" aria-describedby="range-2095-messages">
                                <span class="fr-range__min" aria-hidden="true">0</span>
                                <span class="fr-range__max" aria-hidden="true">100</span>
                            </div>
                            <div class="fr-messages-group" id="range-2095-messages" aria-live="polite">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2099">Extrait de code</button>
                            </h3>
                            <div id="snippet-2099" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group" id="range-2098-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-range-group" id="range-2101-group">
                            <label class="fr-label">
                                Libellé
                                <span class="fr-hint-text">Texte de description additionnel, valeur de 0 à 100.</span>
                            </label>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2104">Extrait de code</button>
                            </h3>
                            <div id="snippet-2104" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group" id="range-2103-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2109">Extrait de code</button>
                            </h3>
                            <div id="snippet-2109" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group" id="range-2108-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-range-group" id="range-2111-group">
                            ...
                            <div class="fr-range fr-range--step">
                                <span class="fr-range__output">50</span>
                                <input id="range-2110" name="range-2110" type="range" aria-labelledby="range-2110-label" max="100" value="50" step="10" aria-describedby="range-2110-messages">
                                <span class="fr-range__min" aria-hidden="true">0</span>
                                <span class="fr-range__max" aria-hidden="true">100</span>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2114">Extrait de code</button>
                            </h3>
                            <div id="snippet-2114" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group" id="range-2113-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2119">Extrait de code</button>
                            </h3>
                            <div id="snippet-2119" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group" id="range-2118-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-range-group" id="range-2121-group">
                            ...
                            <div class="fr-range fr-range--double">
                                ...
                                <input id="range-2120" name="range-2120" type="range" aria-labelledby="range-2120-label" max="100" value="25" aria-describedby="range-2120-messages">
                                <input id="range-2120-2" name="range-2120-2" type="range" aria-labelledby="range-2120-label" max="100" value="75" aria-describedby="range-2120-messages">
                                <span class="fr-range__min" aria-hidden="true">0</span>
                                <span class="fr-range__max" aria-hidden="true">100</span>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2124">Extrait de code</button>
                            </h3>
                            <div id="snippet-2124" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group" id="range-2123-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2129">Extrait de code</button>
                            </h3>
                            <div id="snippet-2129" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group" id="range-2128-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-range-group" id="range-2131-group">
                            ...
                            <div class="fr-range" data-fr-prefix="~" data-fr-suffix="%">
                                <span class="fr-range__output">~50%</span>
                                <input id="range-2130" name="range-2130" type="range" aria-labelledby="range-2130-label" max="100" value="50" aria-describedby="range-2130-messages">
                                <span class="fr-range__min" aria-hidden="true">~0%</span>
                                <span class="fr-range__max" aria-hidden="true">~100%</span>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2134">Extrait de code</button>
                            </h3>
                            <div id="snippet-2134" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group" id="range-2133-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-range-group fr-range-group--disabled" id="range-2136-group">
                            <label class="fr-label">
                                Libellé
                                <span class="fr-hint-text">Texte de description additionnel, valeur de 0 à 100.</span>
                            </label>
                            <div class="fr-range">
                                <span class="fr-range__output">50</span>
                                <input id="range-2135" name="range-2135" type="range" aria-labelledby="range-2135-label" max="100" value="50" disabled aria-describedby="range-2135-messages">
                                <span class="fr-range__min" aria-hidden="true">0</span>
                                <span class="fr-range__max" aria-hidden="true">100</span>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2139">Extrait de code</button>
                            </h3>
                            <div id="snippet-2139" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group fr-range-group--disabled" id="range-2138-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Curseur avec étape désactivé</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-range-group fr-range-group--disabled" id="range-2141-group">
                            ...
                            <div class="fr-range fr-range--step">
                                <span class="fr-range__output">50</span>
                                <input id="range-2140" name="range-2140" type="range" aria-labelledby="range-2140-label" max="100" value="50" step="10" disabled aria-describedby="range-2140-messages">
                                <span class="fr-range__min" aria-hidden="true">0</span>
                                <span class="fr-range__max" aria-hidden="true">100</span>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2144">Extrait de code</button>
                            </h3>
                            <div id="snippet-2144" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group fr-range-group--disabled" id="range-2143-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Curseur double désactivé</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-range-group fr-range-group--disabled" id="range-2146-group">
                            ...
                            <div class="fr-range fr-range--double">
                                ...
                                <input id="range-2145" name="range-2145" type="range" aria-labelledby="range-2145-label" max="100" value="20" disabled aria-describedby="range-2145-messages">
                                <input id="range-2145-2" name="range-2145-2" type="range" aria-labelledby="range-2145-label" max="100" value="80" disabled aria-describedby="range-2145-messages">
                                <span class="fr-range__min" aria-hidden="true">0</span>
                                <span class="fr-range__max" aria-hidden="true">100</span>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2149">Extrait de code</button>
                            </h3>
                            <div id="snippet-2149" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group fr-range-group--disabled" id="range-2148-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-range-group fr-range-group--error" id="range-2151-group">
                            <label class="fr-label">
                                Libellé
                                <span class="fr-hint-text">Texte de description additionnel, valeur de 0 à 100.</span>
                            </label>
                            <div class="fr-range">
                                <span class="fr-range__output">50</span>
                                <input id="range-2150" name="range-2150" type="range" aria-labelledby="range-2150-label" max="100" value="50" aria-describedby="range-2150-messages">
                                <span class="fr-range__min" aria-hidden="true">0</span>
                                <span class="fr-range__max" aria-hidden="true">100</span>
                            </div>
                            <div class="fr-messages-group" id="range-2150-messages" aria-live="polite">
                                <p class="fr-message fr-message--error" id="range-2150-message-error">Valeur sélectionnée impossible</p>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2154">Extrait de code</button>
                            </h3>
                            <div id="snippet-2154" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-range-group fr-range-group--error" id="range-2153-group"&gt;
    &lt;label class="fr-label"&gt;
        Libellé
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel, valeur de 0 à 100.&lt;/span&gt;
    &lt;/label&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-2155" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
