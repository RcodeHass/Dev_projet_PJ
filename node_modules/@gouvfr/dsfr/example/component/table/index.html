...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/tableau" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>Tableau MD (défaut)</h3>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7156">Extrait de code</button>
                    </h3>
                    <div id="snippet-7156" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table" id="table-md-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-md"&gt;
...
&lt;/div&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7157">Extrait de code</button>
                    </h3>
                    <div id="snippet-7157" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--sm" id="table-sm-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-sm"&gt;
...
&lt;/div&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7158">Extrait de code</button>
                    </h3>
                    <div id="snippet-7158" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--lg" id="table-lg-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-lg"&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau avec bordures verticales</h3>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7159">Extrait de code</button>
                    </h3>
                    <div id="snippet-7159" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--bordered" id="table-bordered-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-bordered"&gt;
...
&lt;/div&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7160">Extrait de code</button>
                    </h3>
                    <div id="snippet-7160" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--no-scroll" id="table-no-scroll-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-no-scroll"&gt;
...
&lt;/div&gt;
            ...
            <h3>Exemple des colonnes de tailles minimales fixées</h3>
            <p class="fr-text--sm fr-text-mention-grey">En ajoutant les classes <code>fr-col--xs, fr-col--sm, fr-col--md ou fr-col--lg</code> sur les cellules d'en-tête du tableau</p>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7161">Extrait de code</button>
                    </h3>
                    <div id="snippet-7161" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table" id="table-column-sizes-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-column-sizes"&gt;
...
&lt;/div&gt;
            ...
            <h3>Exemple des classes utilitaires d&#39;alignement</h3>
            <p class="fr-text--sm fr-text-mention-grey">Par défaut le contenu des cellules est centré verticalement et aligné à gauche mais peut être modifié à l'aide des classe utilitaires <code>fr-cell--top, fr-cell--bottom</code> pour l'alignement vertical et <code>fr-cell--center, fr-cell--right</code> pour l'alignement horizontal</p>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7162">Extrait de code</button>
                    </h3>
                    <div id="snippet-7162" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--bordered" id="table-default-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-default"&gt;
...
&lt;/div&gt;
            ...
            <h3>Exemple de cellules avec retour à la ligne automatique</h3>
            <p class="fr-text--sm fr-text-mention-grey">Il est possible de réactiver le retour à la ligne des éléments inline en ajoutant la classe <code>fr-cell--multiline</code> sur l'element <code>table</code>, une ligne ou une cellule du tableau</p>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7163">Extrait de code</button>
                    </h3>
                    <div id="snippet-7163" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table" id="table-multiline-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table class="fr-cell--multiline" id="table-multiline"&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau avec titre invisible</h3>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7164">Extrait de code</button>
                    </h3>
                    <div id="snippet-7164" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--no-caption" id="table-noCaption-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-noCaption"&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau avec titre en bas</h3>
            <div class="fr-mb-6v">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7165">Extrait de code</button>
                    </h3>
                    <div id="snippet-7165" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--caption-bottom" id="table-captionBottom-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-captionBottom"&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau avec lignes sélectionnables</h3>
            <div class="fr-mb-6v">
                                ...
                                <table id="table-selectable">
                                    ...
                                    <tbody>
                                        <tr id="table-selectable-row-key-1" data-row-key="1">
                                            <th class="fr-cell--fixed" scope="row">
                                                <div class="fr-checkbox-group fr-checkbox-group--sm">
                                                    <input data-fr-row-select="true" id="table-select-checkbox-7166--0" type="checkbox">
                                                    <label class="fr-label" for="table-select-checkbox-7166--0">
                                        ...
                                        <tr id="table-selectable-row-key-2" data-row-key="2">
                                            <th class="fr-cell--fixed" scope="row">
                                                <div class="fr-checkbox-group fr-checkbox-group--sm">
                                                    <input data-fr-row-select="true" id="table-select-checkbox-7168--1" type="checkbox">
                                                    <label class="fr-label" for="table-select-checkbox-7168--1">
                                        ...
                                        <tr id="table-selectable-row-key-3" data-row-key="3">
                                            <th class="fr-cell--fixed" scope="row">
                                                <div class="fr-checkbox-group fr-checkbox-group--sm">
                                                    <input data-fr-row-select="true" id="table-select-checkbox-7170--2" type="checkbox">
                                                    <label class="fr-label" for="table-select-checkbox-7170--2">
                                        ...
                                        <tr id="table-selectable-row-key-4" data-row-key="4">
                                            <th class="fr-cell--fixed" scope="row">
                                                <div class="fr-checkbox-group fr-checkbox-group--sm">
                                                    <input data-fr-row-select="true" id="table-select-checkbox-7172--3" type="checkbox">
                                                    <label class="fr-label" for="table-select-checkbox-7172--3">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7182">Extrait de code</button>
                    </h3>
                    <div id="snippet-7182" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table" id="table-selectable-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-selectable"&gt;
                    ...
                    &lt;tbody&gt;
                        &lt;tr id="table-selectable-row-key-1" data-row-key="1"&gt;
                            &lt;th class="fr-cell--fixed" scope="row"&gt;
                                &lt;div class="fr-checkbox-group fr-checkbox-group--sm"&gt;
                                    &lt;input data-fr-row-select="true" id="table-select-checkbox-7174--0" type="checkbox"&gt;
                                    &lt;label class="fr-label" for="table-select-checkbox-7174--0"&gt;
                                        Sélectionner la ligne 1
                                    &lt;/label&gt;
                                &lt;/div&gt;
                            &lt;/th&gt;
                        ...
                        &lt;tr id="table-selectable-row-key-2" data-row-key="2"&gt;
                            &lt;th class="fr-cell--fixed" scope="row"&gt;
                                &lt;div class="fr-checkbox-group fr-checkbox-group--sm"&gt;
                                    &lt;input data-fr-row-select="true" id="table-select-checkbox-7176--1" type="checkbox"&gt;
                                    &lt;label class="fr-label" for="table-select-checkbox-7176--1"&gt;
                                        Sélectionner la ligne 2
                                    &lt;/label&gt;
                                &lt;/div&gt;
                            &lt;/th&gt;
                        ...
                        &lt;tr id="table-selectable-row-key-3" data-row-key="3"&gt;
                            &lt;th class="fr-cell--fixed" scope="row"&gt;
                                &lt;div class="fr-checkbox-group fr-checkbox-group--sm"&gt;
                                    &lt;input data-fr-row-select="true" id="table-select-checkbox-7178--2" type="checkbox"&gt;
                                    &lt;label class="fr-label" for="table-select-checkbox-7178--2"&gt;
                                        Sélectionner la ligne 3
                                    &lt;/label&gt;
                                &lt;/div&gt;
                            &lt;/th&gt;
                        ...
                        &lt;tr id="table-selectable-row-key-4" data-row-key="4"&gt;
                            &lt;th class="fr-cell--fixed" scope="row"&gt;
                                &lt;div class="fr-checkbox-group fr-checkbox-group--sm"&gt;
                                    &lt;input data-fr-row-select="true" id="table-select-checkbox-7180--3" type="checkbox"&gt;
                                    &lt;label class="fr-label" for="table-select-checkbox-7180--3"&gt;
                                        Sélectionner la ligne 4
                                    &lt;/label&gt;
                                &lt;/div&gt;
                            &lt;/th&gt;
...
&lt;/div&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7183">Extrait de code</button>
                    </h3>
                    <div id="snippet-7183" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table" id="table-double-entry-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-double-entry"&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau complexe (comportant des cellules fusionnées)</h3>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7184">Extrait de code</button>
                    </h3>
                    <div id="snippet-7184" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--bordered" id="table-complex-component"&gt;
    &lt;div class="fr-table__wrapper"&gt;
        &lt;div class="fr-table__container"&gt;
            &lt;div class="fr-table__content"&gt;
                &lt;table id="table-complex"&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau avec filtre et navigation comportant différents types de données</h3>
            <div class="fr-mb-6v">
                <div class="fr-table" id="table-miscellaneous-component">
                    <div class="fr-table__header">
                        <fieldset class="fr-segmented fr-segmented--no-legend" id="table-header-segmented-7215">
                            <legend class="fr-segmented__legend">
                                Type d&#39;affichage
                            </legend>
                            <div class="fr-segmented__elements">
                                <div class="fr-segmented__element">
                                    <input value="1" checked type="radio" id="table-header-segmented-table-7216" name="table-header-segmented-table">
                                    <label class="fr-icon-table-line fr-label" for="table-header-segmented-table-7216">
                                        Tableau
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="2" type="radio" id="table-header-segmented-list-7217" name="table-header-segmented-table">
                                    <label class="fr-icon-list-unordered fr-label" for="table-header-segmented-list-7217">
                                        Liste
                                    </label>
                                </div>
                            </div>
                        ...
                        <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-md fr-btns-group--icon-left">
                            <li>
                                <button type="button" id="table-header-button-primary-7213" class="fr-btn fr-icon-settings-5-line fr-btn--icon-left fr-btn--secondary">Action groupée</button>
                            </li>
                            <li>
                                <button type="button" id="table-header-button-secondary-7214" class="fr-btn fr-icon-settings-5-line fr-btn--icon-left fr-btn--secondary">Action groupée</button>
                            </li>
                        </ul>
                    </div>
                    <div class="fr-table__wrapper">
                                ...
                                <table id="table-miscellaneous">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <button aria-describedby="table-miscellaneous-thead-tooltip" type="button" id="table-default-button-7187" class="fr-ml-2v fr-btn--tooltip fr-btn fr-btn--sm">Texte par défaut</button>
                                                <span class="fr-tooltip fr-placement" id="table-miscellaneous-thead-tooltip" role="tooltip">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</span>
                                            </th>
                                            <th>
                                    ...
                                    <tbody>
                                        <tr id="table-miscellaneous-row-key-1" data-row-key="1">
                                            ...
                                            <td>
                                                <div class="fr-input-group" id="input-group-7190">
                                            ...
                                            <td>
                                                <button type="button" id="table-default-button-7191" class="fr-btn fr-btn--sm fr-btn--secondary">Libellé bouton</button>
                                            </td>
                                            <td>
                                                <a class="fr-tag" href="#">Libellé par défaut</a>
                                            </td>
                                            <td>
                                                <a id="link-7192" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download">Lien de Téléchargement <span class="fr-link__detail">JPG – 61,88 Ko</span>
                                                </a>
                                            </td>
                                            <td>
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                                        ...
                                        <tr id="table-miscellaneous-row-key-2" data-row-key="2">
                                            ...
                                            <td>
                                                <div class="fr-input-group" id="input-group-7194">
                                            ...
                                            <td>
                                                <button type="button" id="table-default-button-7195" class="fr-btn fr-btn--sm fr-btn--secondary">Libellé bouton</button>
                                            </td>
                                            <td>
                                                <a class="fr-tag" href="#">Libellé par défaut</a>
                                            </td>
                                            <td>
                                                <a id="link-7196" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download">Lien de Téléchargement <span class="fr-link__detail">JPG – 61,88 Ko</span>
                                                </a>
                                            </td>
                                            <td>
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                                        ...
                                        <tr id="table-miscellaneous-row-key-3" data-row-key="3">
                                            ...
                                            <td>
                                                <div class="fr-input-group" id="input-group-7198">
                                            ...
                                            <td>
                                                <button type="button" id="table-default-button-7199" class="fr-btn fr-btn--sm fr-btn--secondary">Libellé bouton</button>
                                            </td>
                                            <td>
                                                <a class="fr-tag" href="#">Libellé par défaut</a>
                                            </td>
                                            <td>
                                                <a id="link-7200" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download">Lien de Téléchargement <span class="fr-link__detail">JPG – 61,88 Ko</span>
                                                </a>
                                            </td>
                                            <td>
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                                        ...
                                        <tr id="table-miscellaneous-row-key-4" data-row-key="4">
                                            ...
                                            <td>
                                                <div class="fr-input-group" id="input-group-7202">
                                            ...
                                            <td>
                                                <button type="button" id="table-default-button-7203" class="fr-btn fr-btn--sm fr-btn--secondary">Libellé bouton</button>
                                            </td>
                                            <td>
                                                <a class="fr-tag" href="#">Libellé par défaut</a>
                                            </td>
                                            <td>
                                                <a id="link-7204" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download">Lien de Téléchargement <span class="fr-link__detail">JPG – 61,88 Ko</span>
                                                </a>
                                            </td>
                                            <td>
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                                        ...
                                        <tr id="table-miscellaneous-row-key-5" data-row-key="5">
                                            ...
                                            <td>
                                                <div class="fr-input-group" id="input-group-7206">
                                            ...
                                            <td>
                                                <button type="button" id="table-default-button-7207" class="fr-btn fr-btn--sm fr-btn--secondary">Libellé bouton</button>
                                            </td>
                                            <td>
                                                <a class="fr-tag" href="#">Libellé par défaut</a>
                                            </td>
                                            <td>
                                                <a id="link-7208" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download">Lien de Téléchargement <span class="fr-link__detail">JPG – 61,88 Ko</span>
                                                </a>
                                            </td>
                                            <td>
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                                        ...
                                        <tr id="table-miscellaneous-row-key-6" data-row-key="6">
                                            ...
                                            <td>
                                                <div class="fr-input-group" id="input-group-7210">
                                            ...
                                            <td>
                                                <button type="button" id="table-default-button-7211" class="fr-btn fr-btn--sm fr-btn--secondary">Libellé bouton</button>
                                            </td>
                                            <td>
                                                <a class="fr-tag" href="#">Libellé par défaut</a>
                                            </td>
                                            <td>
                                                <a id="link-7212" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download">Lien de Téléchargement <span class="fr-link__detail">JPG – 61,88 Ko</span>
                                                </a>
                                            </td>
                                            <td>
                                                <svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                    ...
                    <div class="fr-table__footer">
                        <div class="fr-table__footer--start">
                            ...
                            <div class="fr-select-group">
                                <label class="fr-sr-only fr-label" for="table-footer-select-7218">
                                    Nombre de lignes par page
                                </label>
                                <select class="fr-select" aria-describedby="table-footer-select-7218-messages" id="table-footer-select-7218" name="table-footer-select-7218">
                                ...
                                <div class="fr-messages-group" id="table-footer-select-7218-messages" aria-live="polite">
                                </div>
                            </div>
                        </div>
                        <div class="fr-table__footer--middle">
                            <nav role="navigation" class="fr-pagination" aria-label="Pagination" data-fr-analytics-page-total="3">
                                <ul class="fr-pagination__list">
                                    <li>
                                        <a class="fr-pagination__link fr-pagination__link--first" id="table-footer-pagination-7222" title="Première page" aria-disabled="true" role="link">
                                            Première page
                                        </a>
                                    </li>
                                    <li>
                                        <a class="fr-pagination__link fr-pagination__link--prev fr-pagination__link--lg-label" id="table-footer-pagination-7223" title="Précédente" aria-disabled="true" role="link">
                                            Précédente
                                        </a>
                                    </li>
                                    <li>
                                        <a class="fr-pagination__link" id="table-footer-pagination-7219" aria-current="page" title="Page 1">
                                            1
                                        </a>
                                    </li>
                                    <li>
                                        <a class="fr-pagination__link" id="table-footer-pagination-7220" href="#" title="Page 2">
                                            2
                                        </a>
                                    </li>
                                    <li>
                                        <a class="fr-pagination__link fr-hidden fr-unhidden-lg" id="table-footer-pagination-7221" href="#" title="Page 3">
                                            3
                                        </a>
                                    </li>
                                    <li>
                                        <a class="fr-pagination__link fr-pagination__link--next fr-pagination__link--lg-label" id="table-footer-pagination-7224" href="#" title="Suivante">
                                            Suivante
                                        </a>
                                    </li>
                                    <li>
                                        <a class="fr-pagination__link fr-pagination__link--last" id="table-footer-pagination-7225" href="#" title="Dernière page">
                                            Dernière page
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="fr-table__footer--end">
                            <ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-md">
                                <li>
                                    <button type="button" id="table-footer-button-primary-7226" class="fr-btn">Action tableau</button>
                                </li>
                                <li>
                                    <button type="button" id="table-footer-button-secondary-7227" class="fr-btn fr-btn--secondary">Action tableau</button>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7271">Extrait de code</button>
                    </h3>
                    <div id="snippet-7271" class="fr-collapse">
                        <pre class=" language-html"><code>&lt;div class="fr-table" id="table-miscellaneous-component"&gt;
    &lt;div class="fr-table__header"&gt;
        &lt;fieldset class="fr-segmented fr-segmented--no-legend" id="table-header-segmented-7258"&gt;
            &lt;legend class="fr-segmented__legend"&gt;
                Type d&amp;#39;affichage
            &lt;/legend&gt;
            &lt;div class="fr-segmented__elements"&gt;
                &lt;div class="fr-segmented__element"&gt;
                    &lt;input value="1" checked type="radio" id="table-header-segmented-table-7259" name="table-header-segmented-table"&gt;
                    &lt;label class="fr-icon-table-line fr-label" for="table-header-segmented-table-7259"&gt;
                        Tableau
                    &lt;/label&gt;
                &lt;/div&gt;
                &lt;div class="fr-segmented__element"&gt;
                    &lt;input value="2" type="radio" id="table-header-segmented-list-7260" name="table-header-segmented-table"&gt;
                    &lt;label class="fr-icon-list-unordered fr-label" for="table-header-segmented-list-7260"&gt;
                        Liste
                    &lt;/label&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        ...
        &lt;ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-md fr-btns-group--icon-left"&gt;
            &lt;li&gt;
                &lt;button type="button" id="table-header-button-primary-7256" class="fr-btn fr-icon-settings-5-line fr-btn--icon-left fr-btn--secondary"&gt;Action groupée&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button type="button" id="table-header-button-secondary-7257" class="fr-btn fr-icon-settings-5-line fr-btn--icon-left fr-btn--secondary"&gt;Action groupée&lt;/button&gt;
            &lt;/li&gt;
        &lt;/ul&gt;
    &lt;/div&gt;
    &lt;div class="fr-table__wrapper"&gt;
                ...
                &lt;table id="table-miscellaneous"&gt;
                    ...
                    &lt;thead&gt;
                        &lt;tr&gt;
                            ...
                            &lt;th&gt;
                                &lt;span class="fr-cell__desc"&gt;Texte par défaut&lt;/span&gt;
                                &lt;button aria-describedby="table-miscellaneous-thead-tooltip" type="button" id="table-default-button-7230" class="fr-ml-2v fr-btn--tooltip fr-btn fr-btn--sm"&gt;Texte par défaut&lt;/button&gt;
                    ...
                    &lt;tbody&gt;
                        &lt;tr id="table-miscellaneous-row-key-1" data-row-key="1"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;div class="fr-input-group" id="input-group-7233"&gt;
                                    &lt;label class="fr-label" for="text-input-text-1"&gt;
                                    &lt;/label&gt;
                                    &lt;input class="fr-input" aria-describedby="text-input-text-1-messages" id="text-input-text-1" type="text"&gt;
                                    &lt;div class="fr-messages-group" id="text-input-text-1-messages" aria-live="polite"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;button type="button" id="table-default-button-7234" class="fr-btn fr-btn--sm fr-btn--secondary"&gt;Libellé bouton&lt;/button&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a class="fr-tag" href="#"&gt;Libellé par défaut&lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a id="link-7235" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download"&gt;Lien de Téléchargement &lt;span class="fr-link__detail"&gt;JPG – 61,88 Ko&lt;/span&gt;
                                &lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
                        ...
                        &lt;tr id="table-miscellaneous-row-key-2" data-row-key="2"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;div class="fr-input-group" id="input-group-7237"&gt;
                                    &lt;label class="fr-label" for="text-input-text-2"&gt;
                                    &lt;/label&gt;
                                    &lt;input class="fr-input" aria-describedby="text-input-text-2-messages" id="text-input-text-2" type="text"&gt;
                                    &lt;div class="fr-messages-group" id="text-input-text-2-messages" aria-live="polite"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;button type="button" id="table-default-button-7238" class="fr-btn fr-btn--sm fr-btn--secondary"&gt;Libellé bouton&lt;/button&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a class="fr-tag" href="#"&gt;Libellé par défaut&lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a id="link-7239" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download"&gt;Lien de Téléchargement &lt;span class="fr-link__detail"&gt;JPG – 61,88 Ko&lt;/span&gt;
                                &lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
                        ...
                        &lt;tr id="table-miscellaneous-row-key-3" data-row-key="3"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;div class="fr-input-group" id="input-group-7241"&gt;
                                    &lt;label class="fr-label" for="text-input-text-3"&gt;
                                    &lt;/label&gt;
                                    &lt;input class="fr-input" aria-describedby="text-input-text-3-messages" id="text-input-text-3" type="text"&gt;
                                    &lt;div class="fr-messages-group" id="text-input-text-3-messages" aria-live="polite"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;button type="button" id="table-default-button-7242" class="fr-btn fr-btn--sm fr-btn--secondary"&gt;Libellé bouton&lt;/button&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a class="fr-tag" href="#"&gt;Libellé par défaut&lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a id="link-7243" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download"&gt;Lien de Téléchargement &lt;span class="fr-link__detail"&gt;JPG – 61,88 Ko&lt;/span&gt;
                                &lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
                        ...
                        &lt;tr id="table-miscellaneous-row-key-4" data-row-key="4"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;div class="fr-input-group" id="input-group-7245"&gt;
                                    &lt;label class="fr-label" for="text-input-text-4"&gt;
                                    &lt;/label&gt;
                                    &lt;input class="fr-input" aria-describedby="text-input-text-4-messages" id="text-input-text-4" type="text"&gt;
                                    &lt;div class="fr-messages-group" id="text-input-text-4-messages" aria-live="polite"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;button type="button" id="table-default-button-7246" class="fr-btn fr-btn--sm fr-btn--secondary"&gt;Libellé bouton&lt;/button&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a class="fr-tag" href="#"&gt;Libellé par défaut&lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a id="link-7247" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download"&gt;Lien de Téléchargement &lt;span class="fr-link__detail"&gt;JPG – 61,88 Ko&lt;/span&gt;
                                &lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
                        ...
                        &lt;tr id="table-miscellaneous-row-key-5" data-row-key="5"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;div class="fr-input-group" id="input-group-7249"&gt;
                                    &lt;label class="fr-label" for="text-input-text-5"&gt;
                                    &lt;/label&gt;
                                    &lt;input class="fr-input" aria-describedby="text-input-text-5-messages" id="text-input-text-5" type="text"&gt;
                                    &lt;div class="fr-messages-group" id="text-input-text-5-messages" aria-live="polite"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;button type="button" id="table-default-button-7250" class="fr-btn fr-btn--sm fr-btn--secondary"&gt;Libellé bouton&lt;/button&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a class="fr-tag" href="#"&gt;Libellé par défaut&lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a id="link-7251" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download"&gt;Lien de Téléchargement &lt;span class="fr-link__detail"&gt;JPG – 61,88 Ko&lt;/span&gt;
                                &lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
                        ...
                        &lt;tr id="table-miscellaneous-row-key-6" data-row-key="6"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;div class="fr-input-group" id="input-group-7253"&gt;
                                    &lt;label class="fr-label" for="text-input-text-6"&gt;
                                    &lt;/label&gt;
                                    &lt;input class="fr-input" aria-describedby="text-input-text-6-messages" id="text-input-text-6" type="text"&gt;
                                    &lt;div class="fr-messages-group" id="text-input-text-6-messages" aria-live="polite"&gt;
                            ...
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;button type="button" id="table-default-button-7254" class="fr-btn fr-btn--sm fr-btn--secondary"&gt;Libellé bouton&lt;/button&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a class="fr-tag" href="#"&gt;Libellé par défaut&lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;a id="link-7255" download="true" href="/example/img/image.jpg" class="fr-link fr-link--download"&gt;Lien de Téléchargement &lt;span class="fr-link__detail"&gt;JPG – 61,88 Ko&lt;/span&gt;
                                &lt;/a&gt;
                            &lt;/td&gt;
                            &lt;td&gt;
                                &lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
    ...
    &lt;div class="fr-table__footer"&gt;
        &lt;div class="fr-table__footer--start"&gt;
            &lt;p class="fr-table__detail"&gt;215 lignes&lt;/p&gt;
            &lt;div class="fr-select-group"&gt;
                &lt;label class="fr-sr-only fr-label" for="table-footer-select-7261"&gt;
                    Nombre de lignes par page
                &lt;/label&gt;
                &lt;select class="fr-select" aria-describedby="table-footer-select-7261-messages" id="table-footer-select-7261" name="table-footer-select-7261"&gt;
                    &lt;option value="" selected disabled hidden&gt;Nombre de lignes par page&lt;/option&gt;
                    &lt;option value="4"&gt;4 lignes par page&lt;/option&gt;
                    &lt;option value="10"&gt;10 lignes par page&lt;/option&gt;
                    &lt;option value="20"&gt;20 lignes par page&lt;/option&gt;
                &lt;/select&gt;
                &lt;div class="fr-messages-group" id="table-footer-select-7261-messages" aria-live="polite"&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
        &lt;div class="fr-table__footer--middle"&gt;
            &lt;nav role="navigation" class="fr-pagination" aria-label="Pagination" data-fr-analytics-page-total="3"&gt;
                &lt;ul class="fr-pagination__list"&gt;
                    &lt;li&gt;
                        &lt;a class="fr-pagination__link fr-pagination__link--first" id="table-footer-pagination-7265" title="Première page" aria-disabled="true" role="link"&gt;
                            Première page
                        &lt;/a&gt;
                    &lt;/li&gt;
                    &lt;li&gt;
                        &lt;a class="fr-pagination__link fr-pagination__link--prev fr-pagination__link--lg-label" id="table-footer-pagination-7266" title="Précédente" aria-disabled="true" role="link"&gt;
                            Précédente
                        &lt;/a&gt;
                    &lt;/li&gt;
                    &lt;li&gt;
                        &lt;a class="fr-pagination__link" id="table-footer-pagination-7262" aria-current="page" title="Page 1"&gt;
                            1
                        &lt;/a&gt;
                    &lt;/li&gt;
                    &lt;li&gt;
                        &lt;a class="fr-pagination__link" id="table-footer-pagination-7263" href="#" title="Page 2"&gt;
                            2
                        &lt;/a&gt;
                    &lt;/li&gt;
                    &lt;li&gt;
                        &lt;a class="fr-pagination__link fr-hidden fr-unhidden-lg" id="table-footer-pagination-7264" href="#" title="Page 3"&gt;
                            3
                        &lt;/a&gt;
                    &lt;/li&gt;
                    &lt;li&gt;
                        &lt;a class="fr-pagination__link fr-pagination__link--next fr-pagination__link--lg-label" id="table-footer-pagination-7267" href="#" title="Suivante"&gt;
                            Suivante
                        &lt;/a&gt;
                    &lt;/li&gt;
                    &lt;li&gt;
                        &lt;a class="fr-pagination__link fr-pagination__link--last" id="table-footer-pagination-7268" href="#" title="Dernière page"&gt;
                            Dernière page
                        &lt;/a&gt;
                    &lt;/li&gt;
                &lt;/ul&gt;
        ...
        &lt;div class="fr-table__footer--end"&gt;
            &lt;ul class="fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-md"&gt;
                &lt;li&gt;
                    &lt;button type="button" id="table-footer-button-primary-7269" class="fr-btn"&gt;Action tableau&lt;/button&gt;
                &lt;/li&gt;
                &lt;li&gt;
                    &lt;button type="button" id="table-footer-button-secondary-7270" class="fr-btn fr-btn--secondary"&gt;Action tableau&lt;/button&gt;
                &lt;/li&gt;
            &lt;/ul&gt;
        &lt;/div&gt;
    &lt;/div&gt;
&lt;/div&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7272" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
    ...
    <script type="module" src="../../../dist/component/checkbox/checkbox.module.js"></script>
    ...
    <script type="text/javascript" nomodule src="../../../dist/component/checkbox/checkbox.nomodule.js"></script>
