...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/case-a-cocher" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1854">Extrait de code</button>
                            </h3>
                            <div id="snippet-1854" class="fr-collapse">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1855">Extrait de code</button>
                            </h3>
                            <div id="snippet-1855" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input id="checkbox-sup-sub" type="checkbox" aria-describedby="checkbox-sup-sub-messages"&gt;
    &lt;label class="fr-label" for="checkbox-sup-sub"&gt;
        &lt;span&gt;Libellé checkbox &lt;sub&gt;sub&lt;/sub&gt; et &lt;sup&gt;sup&lt;/sup&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1856">Extrait de code</button>
                            </h3>
                            <div id="snippet-1856" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input id="checkbox-hint" type="checkbox" aria-describedby="checkbox-hint-messages"&gt;
    &lt;label class="fr-label" for="checkbox-hint"&gt;
        Libellé checkbox
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1857">Extrait de code</button>
                            </h3>
                            <div id="snippet-1857" class="fr-collapse">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1858">Extrait de code</button>
                            </h3>
                            <div id="snippet-1858" class="fr-collapse">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1859">Extrait de code</button>
                            </h3>
                            <div id="snippet-1859" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1860">Extrait de code</button>
                            </h3>
                            <div id="snippet-1860" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1861">Extrait de code</button>
                            </h3>
                            <div id="snippet-1861" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1862">Extrait de code</button>
                            </h3>
                            <div id="snippet-1862" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1863">Extrait de code</button>
                            </h3>
                            <div id="snippet-1863" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1864">Extrait de code</button>
                            </h3>
                            <div id="snippet-1864" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1865">Extrait de code</button>
                            </h3>
                            <div id="snippet-1865" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1866">Extrait de code</button>
                            </h3>
                            <div id="snippet-1866" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1867">Extrait de code</button>
                            </h3>
                            <div id="snippet-1867" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1868">Extrait de code</button>
                            </h3>
                            <div id="snippet-1868" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1869">Extrait de code</button>
                            </h3>
                            <div id="snippet-1869" class="fr-collapse">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1870" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
