...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/fil-d-ariane" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                            <button type="button" class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-4038">Voir le fil d’Ariane</button>
                            <div class="fr-collapse" id="breadcrumb-4038">
                                <ol class="fr-breadcrumb__list">
                                    <li>
                                        <button class="fr-breadcrumb__link" type="button" id="breadcrumb-4030">Accueil</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" type="button" id="breadcrumb-4031">Segment 1: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" type="button" id="breadcrumb-4032">Segment 2: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" type="button" id="breadcrumb-4033">Segment 3: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" type="button" id="breadcrumb-4034">Segment 4: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" type="button" id="breadcrumb-4035">Segment 5: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" type="button" id="breadcrumb-4036">Segment 6: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" type="button" id="breadcrumb-4037">Segment 7: lorem ipsum</button>
                                    </li>
                                    <li>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4048">Extrait de code</button>
                            </h3>
                            <div id="snippet-4048" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :"&gt;
    &lt;button type="button" class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-4047"&gt;Voir le fil d’Ariane&lt;/button&gt;
    &lt;div class="fr-collapse" id="breadcrumb-4047"&gt;
        &lt;ol class="fr-breadcrumb__list"&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" type="button" id="breadcrumb-4039"&gt;Accueil&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" type="button" id="breadcrumb-4040"&gt;Segment 1: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" type="button" id="breadcrumb-4041"&gt;Segment 2: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" type="button" id="breadcrumb-4042"&gt;Segment 3: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" type="button" id="breadcrumb-4043"&gt;Segment 4: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" type="button" id="breadcrumb-4044"&gt;Segment 5: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" type="button" id="breadcrumb-4045"&gt;Segment 6: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" type="button" id="breadcrumb-4046"&gt;Segment 7: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" aria-current="page"&gt;Page Actuelle&lt;/a&gt;
            &lt;/li&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4049" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
