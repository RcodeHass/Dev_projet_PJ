...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/blocs-fonctionnels/adresse-electronique" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7619">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7621">Extrait de code</button>
                            </h3>
                            <div id="snippet-7621" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7620"&gt;
    &lt;label class="fr-label" for="text-input-text"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-text-messages" id="text-input-text" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7622">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7624">Extrait de code</button>
                            </h3>
                            <div id="snippet-7624" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7623"&gt;
    &lt;label class="fr-label" for="text-input-number"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" pattern="[0-9]*" inputmode="numeric" aria-describedby="text-input-number-messages" id="text-input-number" type="number"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7627">Extrait de code</button>
                            </h3>
                            <div id="snippet-7627" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7626"&gt;
    &lt;label class="fr-label" for="text-input-search"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-search-messages" id="text-input-search" type="search"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7628">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7630">Extrait de code</button>
                            </h3>
                            <div id="snippet-7630" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7629"&gt;
    &lt;label class="fr-label" for="text-input-date"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-date-messages" id="text-input-date" type="date"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7631">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7633">Extrait de code</button>
                            </h3>
                            <div id="snippet-7633" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7632"&gt;
    &lt;label class="fr-label" for="textarea"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;textarea class="fr-input" aria-describedby="textarea-messages" id="textarea"&gt;&lt;/textarea&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7634">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7636">Extrait de code</button>
                            </h3>
                            <div id="snippet-7636" class="fr-collapse">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7637">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7639">Extrait de code</button>
                            </h3>
                            <div id="snippet-7639" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7638"&gt;
    &lt;label class="fr-label" for="text-input-button"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;div class="fr-input-wrap fr-input-wrap--addon"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7642">Extrait de code</button>
                            </h3>
                            <div id="snippet-7642" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7641"&gt;
    &lt;label class="fr-label" for="text-input-action"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;div class="fr-input-wrap fr-input-wrap--action"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7645">Extrait de code</button>
                            </h3>
                            <div id="snippet-7645" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7644"&gt;
    &lt;label class="fr-label" for="text-input-placeholder"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-placeholder-messages" placeholder="placeholder" id="text-input-placeholder" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7646">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7648">Extrait de code</button>
                            </h3>
                            <div id="snippet-7648" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7647"&gt;
    &lt;label class="fr-label" for="text-input-value"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" value="value" aria-describedby="text-input-value-messages" id="text-input-value" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7649">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7651">Extrait de code</button>
                            </h3>
                            <div id="snippet-7651" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7650"&gt;
    &lt;label class="fr-label" for="text-input-icon"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--disabled" id="input-group-7652">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7654">Extrait de code</button>
                            </h3>
                            <div id="snippet-7654" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--disabled" id="input-group-7653"&gt;
    &lt;label class="fr-label" for="text-input-disabled"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-disabled-messages" disabled id="text-input-disabled" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7657">Extrait de code</button>
                            </h3>
                            <div id="snippet-7657" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7656"&gt;
    &lt;label class="fr-label" for="text-input-hint"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--valid" id="input-group-7658">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7660">Extrait de code</button>
                            </h3>
                            <div id="snippet-7660" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid" id="input-group-7659"&gt;
    &lt;label class="fr-label" for="text-input-valid"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-valid-messages" id="text-input-valid" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error" id="input-group-7661">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7663">Extrait de code</button>
                            </h3>
                            <div id="snippet-7663" class="fr-collapse">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7664" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
