...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/blocs-fonctionnels/numero-de-telephone" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7609">
                            <label class="fr-label" for="tel-7608">
                                Numéro de téléphone
                                <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                            </label>
                            <input class="fr-input" autocomplete="tel" aria-describedby="tel-7608-messages" id="tel-7608" type="tel">
                            <div class="fr-messages-group" id="tel-7608-messages" aria-live="polite">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7612">Extrait de code</button>
                            </h3>
                            <div id="snippet-7612" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7611"&gt;
    &lt;label class="fr-label" for="tel-7610"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-7610-messages" id="tel-7610" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-7610-messages" aria-live="polite"&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                            </div>
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error" id="input-group-7614">
                            <label class="fr-label" for="tel-7613">
                                Numéro de téléphone
                                <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                            </label>
                            <input class="fr-input" autocomplete="tel" aria-describedby="tel-7613-messages" id="tel-7613" type="tel">
                            <div class="fr-messages-group" id="tel-7613-messages" aria-live="polite">
                                <p class="fr-message fr-message--error" id="tel-7613-message-error">Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 1 22 33 44 55</p>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7617">Extrait de code</button>
                            </h3>
                            <div id="snippet-7617" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error" id="input-group-7616"&gt;
    &lt;label class="fr-label" for="tel-7615"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-7615-messages" id="tel-7615" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-7615-messages" aria-live="polite"&gt;
        &lt;p class="fr-message fr-message--error" id="tel-7615-message-error"&gt;Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 1 22 33 44 55&lt;/p&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                            </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7618" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
