...
<body id="top" class="fr-mb-12w">
  ...
  function preventSubmit(e) {
                        ...
                        <div class="fr-mb-6v">
                            <fieldset class="fr-fieldset" id="text" aria-labelledby="text-legend text-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-4050">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-4051">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-4052">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4056">Extrait de code</button>
                                </h3>
                                <div id="snippet-4056" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="text" aria-labelledby="text-legend text-messages"&gt;
    &lt;legend class="fr-fieldset__legend" id="text-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4053"&gt;
            &lt;label class="fr-label" for="text-1"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-1-messages" name="text-1" id="text-1" type="text"&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4054"&gt;
            &lt;label class="fr-label" for="text-2"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-2-messages" name="text-2" id="text-2" type="text"&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4055"&gt;
            &lt;label class="fr-label" for="text-3"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-3-messages" name="text-3" id="text-3" type="text"&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4057">Extrait de code</button>
                                </h3>
                                <div id="snippet-4057" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4058">Extrait de code</button>
                                </h3>
                                <div id="snippet-4058" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4059">Extrait de code</button>
                                </h3>
                                <div id="snippet-4059" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4060">Extrait de code</button>
                                </h3>
                                <div id="snippet-4060" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4061">Extrait de code</button>
                                </h3>
                                <div id="snippet-4061" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4062">Extrait de code</button>
                                </h3>
                                <div id="snippet-4062" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4063">Extrait de code</button>
                                </h3>
                                <div id="snippet-4063" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-6v">
                            <fieldset class="fr-fieldset" id="text-disabled" disabled aria-labelledby="text-disabled-legend text-disabled-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-4064">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-4065">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-4066">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4070">Extrait de code</button>
                                </h3>
                                <div id="snippet-4070" class="fr-collapse">
    ...
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4067"&gt;
            &lt;label class="fr-label" for="text-disabled-1"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4068"&gt;
            &lt;label class="fr-label" for="text-disabled-2"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4069"&gt;
            &lt;label class="fr-label" for="text-disabled-3"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4071">Extrait de code</button>
                                </h3>
                                <div id="snippet-4071" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4072">Extrait de code</button>
                                </h3>
                                <div id="snippet-4072" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-6v">
                            <button title="Envoyer le formulaire" type="button" class="fr-btn">Envoyer</button>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4073">Extrait de code</button>
                                </h3>
                                <div id="snippet-4073" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;button title="Envoyer le formulaire" type="button" class="fr-btn"&gt;Envoyer&lt;/button&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="fr-mb-6v">
                            <input title="Envoyer le formulaire" type="button" value="Envoyer" class="fr-btn">
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4074">Extrait de code</button>
                                </h3>
                                <div id="snippet-4074" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;input title="Envoyer le formulaire" type="button" value="Envoyer" class="fr-btn"&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        <h3>Messages de formulaire</h3>
                        <p class="fr-text--sm fr-text-mention-grey">L'id des messages, ou du groupe de message, doit être associé à l'attribut <em>aria-describedby</em> ou <em>aria-labelledby</em> de l'élément de formulaire auquel il fait référence (le fieldset, ou le champ).</p>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4075">Extrait de code</button>
                                </h3>
                                <div id="snippet-4075" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-messages-group" id="message-group" aria-live="polite"&gt;
    &lt;p class="fr-message" id="message-neutral"&gt;Message neutre&lt;/p&gt;
    &lt;p class="fr-message fr-message--info" id="message-info"&gt;Message d'information&lt;/p&gt;
    &lt;p class="fr-message fr-message--valid" id="message-valid"&gt;Message de succès&lt;/p&gt;
    &lt;p class="fr-message fr-message--warning" id="message-warning"&gt;Message d'avertissement&lt;/p&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4076" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
