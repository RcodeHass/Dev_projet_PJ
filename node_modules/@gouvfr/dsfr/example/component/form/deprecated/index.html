...
<body id="top" class="fr-mb-12w">
  ...
  function preventSubmit(e) {
                            ...
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-input-group" id="input-group-4077">
                                        ...
                                        <div class="fr-input-group" id="input-group-4078">
                                        ...
                                        <div class="fr-input-group" id="input-group-4079">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4083">Extrait de code</button>
                                </h3>
                                <div id="snippet-4083" class="fr-collapse">
    ...
    &lt;fieldset class="fr-fieldset"&gt;
        ...
        &lt;/legend&gt;
        &lt;div class="fr-fieldset__content"&gt;
            &lt;div class="fr-input-group" id="input-group-4080"&gt;
                &lt;label class="fr-label" for="text-deprecated-1"&gt;
                    Libellé champ de saisie
                &lt;/label&gt;
                &lt;input class="fr-input" aria-describedby="text-deprecated-1-messages" name="text-deprecated" id="text-deprecated-1" type="text"&gt;
                ...
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div class="fr-input-group" id="input-group-4081"&gt;
                &lt;label class="fr-label" for="text-deprecated-2"&gt;
                    Libellé champ de saisie
                &lt;/label&gt;
                &lt;input class="fr-input" aria-describedby="text-deprecated-2-messages" name="text-deprecated" id="text-deprecated-2" type="text"&gt;
                ...
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div class="fr-input-group" id="input-group-4082"&gt;
                &lt;label class="fr-label" for="text-deprecated-3"&gt;
                    Libellé champ de saisie
                &lt;/label&gt;
                &lt;input class="fr-input" aria-describedby="text-deprecated-3-messages" name="text-deprecated" id="text-deprecated-3" type="text"&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4084">Extrait de code</button>
                                </h3>
                                <div id="snippet-4084" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4085">Extrait de code</button>
                                </h3>
                                <div id="snippet-4085" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4086">Extrait de code</button>
                                </h3>
                                <div id="snippet-4086" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-inline-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4087">Extrait de code</button>
                                </h3>
                                <div id="snippet-4087" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-inline-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4088">Extrait de code</button>
                                </h3>
                                <div id="snippet-4088" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="radio-error-deprecated-legend radio-error-deprecated-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-error-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4089">Extrait de code</button>
                                </h3>
                                <div id="snippet-4089" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4090">Extrait de code</button>
                                </h3>
                                <div id="snippet-4090" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="checkbox-error-deprecated-legend checkbox-error-deprecated-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-error-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-input-group fr-input-group--disabled" id="input-group-4091">
                                        ...
                                        <div class="fr-input-group fr-input-group--disabled" id="input-group-4092">
                                        ...
                                        <div class="fr-input-group fr-input-group--disabled" id="input-group-4093">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4097">Extrait de code</button>
                                </h3>
                                <div id="snippet-4097" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend" id='text-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
        ...
        &lt;/legend&gt;
        &lt;div class="fr-fieldset__content"&gt;
            &lt;div class="fr-input-group fr-input-group--disabled" id="input-group-4094"&gt;
                &lt;label class="fr-label" for="text-disabled-deprecated-1"&gt;
                    Libellé champ de saisie
                    &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
                &lt;/label&gt;
                ...
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div class="fr-input-group fr-input-group--disabled" id="input-group-4095"&gt;
                &lt;label class="fr-label" for="text-disabled-deprecated-2"&gt;
                    Libellé champ de saisie
                    &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
                &lt;/label&gt;
                ...
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div class="fr-input-group fr-input-group--disabled" id="input-group-4096"&gt;
                &lt;label class="fr-label" for="text-disabled-deprecated-3"&gt;
                    Libellé champ de saisie
                    &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
                &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4098">Extrait de code</button>
                                </h3>
                                <div id="snippet-4098" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4099">Extrait de code</button>
                                </h3>
                                <div id="snippet-4099" class="fr-collapse">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4100" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
