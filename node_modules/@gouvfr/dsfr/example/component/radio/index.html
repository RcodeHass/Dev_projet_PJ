...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/bouton-radio" rel="noopener external" target="_blank" title="${getBlankTitle(d.title)}"> Bouton radio</a>
            </li>
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/bouton-radio-riche" rel="noopener external" target="_blank" title="${getBlankTitle(d.title)}"> Bouton radio riche</a>
            </li>
        </ul>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1458">Extrait de code</button>
                            </h3>
                            <div id="snippet-1458" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1459">Extrait de code</button>
                            </h3>
                            <div id="snippet-1459" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1460">Extrait de code</button>
                            </h3>
                            <div id="snippet-1460" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1461">Extrait de code</button>
                            </h3>
                            <div id="snippet-1461" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1462">Extrait de code</button>
                            </h3>
                            <div id="snippet-1462" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1463">Extrait de code</button>
                            </h3>
                            <div id="snippet-1463" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1464">Extrait de code</button>
                            </h3>
                            <div id="snippet-1464" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1465">Extrait de code</button>
                            </h3>
                            <div id="snippet-1465" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1466">Extrait de code</button>
                            </h3>
                            <div id="snippet-1466" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1467">Extrait de code</button>
                            </h3>
                            <div id="snippet-1467" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1468">Extrait de code</button>
                            </h3>
                            <div id="snippet-1468" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1469">Extrait de code</button>
                            </h3>
                            <div id="snippet-1469" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1470">Extrait de code</button>
                            </h3>
                            <div id="snippet-1470" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1471">Extrait de code</button>
                            </h3>
                            <div id="snippet-1471" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1472">Extrait de code</button>
                            </h3>
                            <div id="snippet-1472" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio riches sans pictogramme, en ligne</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1473">Extrait de code</button>
                            </h3>
                            <div id="snippet-1473" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1474">Extrait de code</button>
                            </h3>
                            <div id="snippet-1474" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1475">Extrait de code</button>
                            </h3>
                            <div id="snippet-1475" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1476">Extrait de code</button>
                            </h3>
                            <div id="snippet-1476" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1477">Extrait de code</button>
                            </h3>
                            <div id="snippet-1477" class="fr-collapse">
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1478">Extrait de code</button>
                            </h3>
                            <div id="snippet-1478" class="fr-collapse">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1479" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
