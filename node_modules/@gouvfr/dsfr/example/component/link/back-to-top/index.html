                ...
                <div class="fr-col-md-8 fr-col-12">
                    <div class="fr-mt-32v">
                        ...
                        <p>Le lien de “retour en haut de page” est une ancre vers un élément dont l’id est "top".
                            ...
                            <br>Le lien haut de page est un lien classique <code>fr-link</code> composé de l'icone <code>arrow-up-fill</code>, alignée à gauche, et du libellé "Haut de page".
                            <br>
                    ...
                    <div class="fr-mb-6v">
                        <a id="link-4623" href="#top" class="fr-link fr-icon-arrow-up-fill fr-link--icon-left">Haut de page</a>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4625">Extrait de code</button>
                            </h3>
                            <div id="snippet-4625" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;a id="link-4624" href="#top" class="fr-link fr-icon-arrow-up-fill fr-link--icon-left"&gt;Haut de page&lt;/a&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4626" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
