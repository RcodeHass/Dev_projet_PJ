...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/barre-de-recherche" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar" id="search-1335" role="search">
                            <label class="fr-label" for="search-1335-input">
                                Rechercher
                            </label>
                            <input class="fr-input" aria-describedby="search-1335-input-messages" placeholder="Rechercher" id="search-1335-input" type="search">
                            <div class="fr-messages-group" id="search-1335-input-messages" aria-live="polite">
                            </div>
                            <button title="Rechercher" type="button" id="search-btn-1336" class="fr-btn">Rechercher</button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1339">Extrait de code</button>
                            </h3>
                            <div id="snippet-1339" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar" id="search-1337" role="search"&gt;
    &lt;label class="fr-label" for="search-1337-input"&gt;
        Rechercher
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="search-1337-input-messages" placeholder="Rechercher" id="search-1337-input" type="search"&gt;
    &lt;div class="fr-messages-group" id="search-1337-input-messages" aria-live="polite"&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar fr-search-bar--lg" id="search-1340" role="search">
                            <label class="fr-label" for="search-1340-input">
                                Rechercher
                            </label>
                            <input class="fr-input" aria-describedby="search-1340-input-messages" placeholder="Rechercher" id="search-1340-input" type="search">
                            <div class="fr-messages-group" id="search-1340-input-messages" aria-live="polite">
                            </div>
                            <button type="button" id="search-btn-1341" class="fr-btn">Rechercher</button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1344">Extrait de code</button>
                            </h3>
                            <div id="snippet-1344" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar fr-search-bar--lg" id="search-1342" role="search"&gt;
    &lt;label class="fr-label" for="search-1342-input"&gt;
        Rechercher
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="search-1342-input-messages" placeholder="Rechercher" id="search-1342-input" type="search"&gt;
    &lt;div class="fr-messages-group" id="search-1342-input-messages" aria-live="polite"&gt;
    &lt;/div&gt;
    &lt;button type="button" id="search-btn-1343" class="fr-btn"&gt;Rechercher&lt;/button&gt;
&lt;/div&gt;
</code></pre>
                            </div>
                        </section>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1345" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
