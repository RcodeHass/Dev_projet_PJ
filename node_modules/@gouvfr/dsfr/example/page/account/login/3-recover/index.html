...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="3a-form">Récupération de mot de passe</a>
            </li>
            <li>
                <a href="3b-confirmation">Confirmation de récupération de mot de passe</a>
            </li>
        </ul>
    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-9069" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
