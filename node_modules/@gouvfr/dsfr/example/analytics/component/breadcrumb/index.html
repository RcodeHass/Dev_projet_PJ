...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>Étiquette d’élément a</h3>
            <div class="fr-mb-6v">
                <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                    <button type="button" class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-107">Voir le fil d’Ariane</button>
                    <div class="fr-collapse" id="breadcrumb-107">
                        <ol class="fr-breadcrumb__list">
                            <li>
                                <a class="fr-breadcrumb__link" id="breadcrumb-99" href="../">Accueil</a>
                            </li>
                            <li>
                                <a class="fr-breadcrumb__link" id="breadcrumb-100" href="../">Segment 1: lorem ipsum</a>
                            </li>
                            <li>
                                <a class="fr-breadcrumb__link" id="breadcrumb-101" href="../">Segment 2: lorem ipsum</a>
                            </li>
                            <li>
                                <a class="fr-breadcrumb__link" id="breadcrumb-102" href="../">Segment 3: lorem ipsum</a>
                            </li>
                            <li>
                                <a class="fr-breadcrumb__link" id="breadcrumb-103" href="../">Segment 4: lorem ipsum</a>
                            </li>
                            <li>
                                <a class="fr-breadcrumb__link" id="breadcrumb-104" href="../">Segment 5: lorem ipsum</a>
                            </li>
                            <li>
                                <a class="fr-breadcrumb__link" id="breadcrumb-105" href="../">Segment 6: lorem ipsum</a>
                            </li>
                            <li>
                                <a class="fr-breadcrumb__link" id="breadcrumb-106" href="../">Segment 7: lorem ipsum</a>
                            </li>
                            <li>
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="breadcrumb-button">Fil d’ariane avec boutons</a>
            </li>
        </ul>
    </div>
