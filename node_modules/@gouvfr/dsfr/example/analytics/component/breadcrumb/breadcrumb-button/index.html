...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>Étiquette d’élément button</h3>
            <div class="fr-mb-6v">
                <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                    <button type="button" class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-116">Voir le fil d’Ariane</button>
                    <div class="fr-collapse" id="breadcrumb-116">
                        <ol class="fr-breadcrumb__list">
                            <li>
                                <button class="fr-breadcrumb__link" type="button" id="breadcrumb-108">Accueil</button>
                            </li>
                            <li>
                                <button class="fr-breadcrumb__link" type="button" id="breadcrumb-109">Segment 1: lorem ipsum</button>
                            </li>
                            <li>
                                <button class="fr-breadcrumb__link" type="button" id="breadcrumb-110">Segment 2: lorem ipsum</button>
                            </li>
                            <li>
                                <button class="fr-breadcrumb__link" type="button" id="breadcrumb-111">Segment 3: lorem ipsum</button>
                            </li>
                            <li>
                                <button class="fr-breadcrumb__link" type="button" id="breadcrumb-112">Segment 4: lorem ipsum</button>
                            </li>
                            <li>
                                <button class="fr-breadcrumb__link" type="button" id="breadcrumb-113">Segment 5: lorem ipsum</button>
                            </li>
                            <li>
                                <button class="fr-breadcrumb__link" type="button" id="breadcrumb-114">Segment 6: lorem ipsum</button>
                            </li>
                            <li>
                                <button class="fr-breadcrumb__link" type="button" id="breadcrumb-115">Segment 7: lorem ipsum</button>
                            </li>
                            <li>
