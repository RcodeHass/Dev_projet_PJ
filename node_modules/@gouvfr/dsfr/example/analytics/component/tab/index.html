                ...
                <div class="fr-tabs">
                    <ul class="fr-tabs__list" role="tablist" aria-label="[A modifier | nom du système d'onglet]">
                        <li role="presentation">
                            <button type="button" id="tab-502" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="0" role="tab" aria-selected="true" aria-controls="tab-502-panel">Libellé onglet 1</button>
                        </li>
                        <li role="presentation">
                            <button type="button" id="tab-503" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tab-503-panel">Libellé onglet 2</button>
                        </li>
                        <li role="presentation">
                            <button type="button" id="tab-504" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tab-504-panel">Libellé onglet 3</button>
                        </li>
                        <li role="presentation">
                            <button type="button" id="tab-505" class="fr-tabs__tab fr-icon-checkbox-circle-line fr-tabs__tab--icon-left" tabindex="-1" role="tab" aria-selected="false" aria-controls="tab-505-panel">Libellé onglet 4</button>
                        </li>
                    </ul>
                    <div id="tab-502-panel" class="fr-tabs__panel fr-tabs__panel--selected" role="tabpanel" aria-labelledby="tab-502" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tab-503-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tab-503" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tab-504-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tab-504" tabindex="0">
                        <!-- données de test -->
                        <div>
                    ...
                    <div id="tab-505-panel" class="fr-tabs__panel" role="tabpanel" aria-labelledby="tab-505" tabindex="0">
                        <!-- données de test -->
                        <div>
