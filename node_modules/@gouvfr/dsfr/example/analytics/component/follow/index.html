...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        ...
        <div class="fr-mb-6v">
            <div class="fr-follow" id="follow-137">
                            ...
                            <div class="fr-follow__newsletter">
                                ...
                                <div>
                                    <ul class="fr-btns-group fr-btns-group--inline-md">
                                        <li>
                                            <button title="S‘abonner à notre lettre d’information" type="button" id="newsletter-button-136" class="fr-btn">S'abonner</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="fr-col-12 fr-col-md-4">
                            <div class="fr-follow__social">
                                ...
                                <ul class="fr-btns-group">
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-138" href="[À MODIFIER - Lien vers le facebook de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--facebook fr-btn">Facebook</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-139" href="[À MODIFIER - Lien vers le twitter de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--twitter-x fr-btn">X (anciennement Twitter)</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-140" href="[À MODIFIER - Lien vers le linkedin de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--linkedin fr-btn">Linkedin</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-141" href="[À MODIFIER - Lien vers l'instagram de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--instagram fr-btn">Instagram</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-142" href="[À MODIFIER - Lien vers le youtube de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--youtube fr-btn">Youtube</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="follow-form">Lettre d&#39;information avec formulaire et Réseaux Sociaux</a>
            </li>
        </ul>
    </div>
