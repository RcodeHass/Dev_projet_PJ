...
<body id="top" class="fr-mb-12w">
            ...
            <div class="fr-mb-6v">
                ...
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-96">Libellé accordéon</button>
                    </h3>
                    <div id="accordion-96" class="fr-collapse">
                        <!-- données de test -->
                        <div>
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="accordion-nested">Accordéon imbriqué</a>
            </li>
        </ul>
    </div>
