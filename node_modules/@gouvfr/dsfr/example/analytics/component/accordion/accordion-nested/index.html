            ...
            <div class="fr-mb-6v">
                ...
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-imbricated-98">Libellé accordéon</button>
                    </h3>
                    <div id="accordion-imbricated-98" class="fr-collapse">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-97">Libellé accordéon</button>
                            </h3>
                            <div id="accordion-97" class="fr-collapse">
                                <!-- données de test -->
                                <div>
