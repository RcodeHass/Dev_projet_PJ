        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--gutters">
                <div class="fr-col-12 fr-col-md-4">
                    <h3>Carte avec liens</h3>
                    <div class="fr-mb-6v">
                        <div id="card-125" class="fr-card">
                            <div class="fr-card__body">
                                ...
                                <div class="fr-card__footer">
                                    <ul class="fr-links-group fr-links-group--inline">
                                        <li>
                                            <a id="link-126" href="#" class="fr-link fr-icon-arrow-right-line fr-link--icon-right">Libellé</a>
                                        </li>
                                        <li>
                                            <a id="link-127" href="#" class="fr-link fr-icon-arrow-right-line fr-link--icon-right">Libellé</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
