...
<body id="top" class="fr-mb-12w">
        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--gutters">
                <div class="fr-col-12 fr-col-md-4">
                    <h3>Carte</h3>
                    <div class="fr-mb-6v">
                        <div id="card-122" class="fr-card fr-enlarge-link">
                            <div class="fr-card__body">
                                <div class="fr-card__content">
                                    <h3 class="fr-card__title">
                                        <a href="../">Intitulé de la carte</a>
                                    </h3>
                                </div>
                            </div>
            ...
            <div class="fr-grid-row fr-grid-row--gutters">
                <div class="fr-col-12 fr-col-md-6">
                    <h3>Carte de téléchargement</h3>
                    <div class="fr-mb-6v">
                        <div id="card-123" class="fr-card fr-enlarge-link fr-card--download">
                            <div class="fr-card__body">
                                <div class="fr-card__content">
                                    <h3 class="fr-card__title">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="card-button">Carte avec boutons</a>
            </li>
            <li>
                <a href="card-link">Carte avec liens</a>
            </li>
            <li>
                <a href="card-tag">Carte avec tags</a>
            </li>
        </ul>
    </div>
