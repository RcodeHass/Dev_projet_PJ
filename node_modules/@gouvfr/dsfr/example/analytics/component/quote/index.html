...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>Exemple de citation</h3>
            <div class="fr-mb-6v">
                <figure id="quote-351" class="fr-quote">
                    ...
                    <figcaption>
                        ...
                        <ul class="fr-quote__source">
                            ...
                            <li>Détail 3</li>
                            <li>
                                <a target="_blank" rel="noopener external" title="Détail 4 - nouvelle fenêtre" href="https://www.systeme-de-design.gouv.fr/">Détail 4</a>
                            </li>
                        </ul>
                    </figcaption>
                </figure>
