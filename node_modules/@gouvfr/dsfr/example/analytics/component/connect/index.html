...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>Se connecter avec FranceConnect</h3>
            <div class="fr-mb-6v">
                <div class="fr-connect-group">
                    <button class="fr-connect" id="connect-131" type="button">
                        <span class="fr-connect__login">S’identifier avec</span>
                        <span class="fr-connect__brand">FranceConnect</span>
                    </button>
                    <p>
                        <a href="https://franceconnect.gouv.fr/" id="connect-link-132" target="_blank" rel="noopener" title="Qu’est-ce que FranceConnect ? - nouvelle fenêtre">Qu’est-ce que FranceConnect ?</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="connect-a">Bouton France Connect avec etiquette a</a>
            </li>
        </ul>
    </div>
