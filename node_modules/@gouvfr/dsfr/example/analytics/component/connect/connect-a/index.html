        ...
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-connect-group">
                    <a class="fr-connect" id="connect-133" href>
                        <span class="fr-connect__login">S’identifier avec</span>
                        <span class="fr-connect__brand">FranceConnect</span>
                    </a>
                    <p>
                        <a href="https://franceconnect.gouv.fr/" id="connect-link-134" target="_blank" rel="noopener" title="Qu’est-ce que FranceConnect ? - nouvelle fenêtre">Qu’est-ce que FranceConnect ?</a>
                    </p>
                </div>
            </div>
        </div>
