...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <h3>bouton</h3>
            <div class="fr-mb-6v">
                <button type="button" id="button-117" class="fr-btn">Libellé button</button>
            </div>
        </div>
    </div>
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="button-a-download">Bouton de téléchargement avec etiquette a</a>
            </li>
            <li>
                <a href="button-a-external">Bouton externe avec etiquette a</a>
            </li>
            <li>
                <a href="button-a-internal">Bouton interne avec etiquette a</a>
            </li>
        </ul>
    </div>
