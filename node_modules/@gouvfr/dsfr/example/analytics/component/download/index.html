...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>Téléchargement de fichier</h3>
            <div class="fr-mb-6v">
                <div class="fr-download" id="download">
                    <h3>
                        <a href="[À MODIFIER - ../../../../example/img/image.jpg]" id="download-link" download class="fr-download__link">Télécharger le document lorem ipsum sit dolores amet
