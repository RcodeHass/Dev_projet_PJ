...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>Interrupteur coché</h3>
            <div class="fr-mb-6v">
                <div class="fr-toggle">
                    <input type="checkbox" class="fr-toggle__input" id="toggle-508" checked aria-describedby="toggle-508-messages">
                    <label class="fr-toggle__label" for="toggle-508" data-fr-checked-label="Activé" data-fr-unchecked-label="Désactivé">Libellé de l'interrupteur</label>
                    <div class="fr-messages-group" id="toggle-508-messages" aria-live="polite">
                    </div>
                </div>
            </div>
        </div>
