...
<body id="top" class="fr-mb-12w">
                            ...
                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                <div class="fr-modal__body">
                                    <div class="fr-modal__header">
                                        <button aria-controls="fr-consent-modal" title="Fermer" type="button" id="button-135" class="fr-btn--close fr-btn">Fermer</button>
                                    </div>
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="consent-placeholder">Gestionnaire de consentement bloc désactivé (placeholder)</a>
            </li>
        </ul>
    </div>
