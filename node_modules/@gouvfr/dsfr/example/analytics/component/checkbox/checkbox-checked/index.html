        ...
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-checkbox-group">
                    <input value="checkbox-value" checked id="checkbox-130" type="checkbox" aria-describedby="checkbox-130-messages">
                    <label class="fr-label" for="checkbox-130">
                        Libellé case à cocher
                    </label>
                    <div class="fr-messages-group" id="checkbox-130-messages" aria-live="polite">
                    </div>
                </div>
            </div>
        </div>
