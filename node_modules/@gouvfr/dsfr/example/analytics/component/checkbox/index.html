...
<body id="top" class="fr-mb-12w">
        ...
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-checkbox-group">
                    <input value="checkbox-value" id="checkbox-129" type="checkbox" aria-describedby="checkbox-129-messages">
                    <label class="fr-label" for="checkbox-129">
                        Libellé case à cocher
                    </label>
                    <div class="fr-messages-group" id="checkbox-129-messages" aria-live="polite">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="checkbox-checked">Case à cocher cochée</a>
            </li>
        </ul>
    </div>
