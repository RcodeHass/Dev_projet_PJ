    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div>
                <h4>button</h4>
                <div class="fr-mb-6v">
                    <a href="javascript:alert('click')" data-fr-analytics-click="libellé envoyé à l'analytics" id="attr-click">libellé du lien</a>
                </div>
            </div>
            <div>
                <h4>lien interne</h4>
                <div class="fr-mb-6v">
                    <a href="../" data-fr-analytics-click="libellé envoyé à l'analytics" id="attr-internal">libellé du lien</a>
                </div>
            </div>
            <div>
                <h4>lien externe</h4>
                <div class="fr-mb-6v">
                    <a href="https://systeme-de-design.gouv.fr" data-fr-analytics-click="libellé envoyé à l'analytics" id="attr-external" target="_blank" rel="noopener external" title="libellé du lien - nouvelle fenêtre">libellé du lien</a>
                </div>
            </div>
            <div>
                <h4>lien download</h4>
                <div class="fr-mb-6v">
                    <a href="" download data-fr-analytics-click="libellé envoyé à l'analytics" id="attr-download">libellé du lien</a>
                </div>
            </div>
        </div>
    </div>
