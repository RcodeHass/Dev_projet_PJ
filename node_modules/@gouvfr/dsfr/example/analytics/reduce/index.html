...
<head>
    ...
    window['dsfr'] = {
      ...
      analytics: {
        ...
        isActionEnabled: 'reduce', // enable action tracking
        cmp: {
          id: 'tarteaucitron'
        },
        page: {
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-mt-0">
                <h2>Action générant une instance</h2>
            </div>
            <h3>bouton</h3>
            <div class="fr-mb-6v">
                <button data-fr-analytics-action="libellé envoyé à l'analytics" type="button" id="button-518" class="fr-btn">Libellé button</button>
            </div>
            <div class="fr-mt-0">
                <h2>Action sans instance</h2>
            </div>
            <h3>bouton</h3>
            <div class="fr-mb-6v">
                <button type="button" id="button-519" class="fr-btn">Libellé button</button>
            </div>
            <h3>bouton</h3>
            <div class="fr-mb-6v">
                <button type="button" id="button-520" class="fr-btn">Libellé button</button>
            </div>
            <div class="fr-mt-0">
                <h2>Accordéon générant une instance</h2>
            </div>
            <h3>Accordéon</h3>
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-521">Libellé accordéon</button>
                    </h3>
                    <div data-fr-analytics-action="libellé envoyé à l'analytics" id="accordion-521" class="fr-collapse">
                        <!-- données de test -->
                        <div>
            ...
            <div class="fr-mt-0">
                <h2>Accordéon sans instance</h2>
            </div>
            <h3>Accordéon</h3>
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-522">Libellé accordéon</button>
                    </h3>
                    <div id="accordion-522" class="fr-collapse">
                        <!-- données de test -->
                        <div>
                            <h4 class="fr-h4">Contenu </h4>
                            <ul>
            ...
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-523">Libellé accordéon</button>
                    </h3>
                    <div id="accordion-523" class="fr-collapse">
                        <!-- données de test -->
                        <div>
                            <h4 class="fr-h4">Contenu </h4>
                            <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
