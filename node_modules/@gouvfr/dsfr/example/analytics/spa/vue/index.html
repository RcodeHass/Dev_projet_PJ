...
<body id="top" class="fr-mb-12w">
                ...
                <div>
                    <header role="banner" class="fr-header" id="header-120">
                                    ...
                                    <div class="fr-header__brand fr-enlarge-link">
                                        <div class="fr-header__brand-top">
                                            ...
                                            <div class="fr-header__operator">
                                                <img class="fr-responsive-img" style="max-width:9.0625rem;" src="../../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - texte alternatif de l’image]" data-fr-js-ratio="true">
                                                <!-- L’alternative de l’image (attribut alt) doit impérativement être renseignée et reprendre le texte visible dans l’image -->
                                            </div>
                                            <div class="fr-header__navbar">
                                                <button type="button" class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-122" id="button-123" title="Rechercher" data-fr-js-modal-button="true">
                                                    Rechercher
                                                </button>
                                    ...
                                    <div class="fr-header__tools">
                                        <div class="fr-header__tools-links">
                                            <ul class="fr-btns-group">
                                                <li>
                                                    <router-link exact-path id="btn-shortcut-1" class="fr-btn" to="/link">Lien</router-link>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="fr-header__menu fr-modal" id="modal-124">
                            <div class="fr-container">
                                <button type="button" class="fr-btn--close fr-btn" aria-controls="modal-124" id="button-133" title="Fermer">
                                    Fermer
                                </button>
                                ...
                                <nav class="fr-nav" id="navigation-134" role="navigation" aria-label="Menu principal">
                                    <ul class="fr-nav__list">
                                        <li class="fr-nav__item">
                                            <router-link exact-path id="link-3" class="fr-nav__link" to="/">Base</router-link>
                                        </li>
                                        <li class="fr-nav__item">
                                            <router-link exact-path id="link-3" class="fr-nav__link" to="/link">Liens</router-link>
                                        </li>
                                        <li class="fr-nav__item">
                                            <router-link exact-path id="link-3" class="fr-nav__link" to="/button">Boutons</router-link>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="fr-container fr-mt-8v">
                        <h2>Contenu router view</h2>
                        <router-view></router-view>
                        <br>
                        <hr class="fr-my-12v">
                        <h2>Affichage conditionné (v-if)</h2>
                        <div v-if="pagination==1">
                            <h1>Page {{pagination}}</h1>
                            <a id="btn-0" href="#" data-fr-analytics-click="libellé envoyé à l'analytics" id="attr-click">Home</a>
                        </div>
                        <div v-if="pagination==2">
                            <h1>Page {{pagination}}</h1>
                            <button type="button" id="btn-1" class="fr-btn">Button 1</button>
                        </div>
                        <div v-if="pagination==3">
                            <h1>Page {{pagination}}</h1>
                            <button type="button" id="btn-2" class="fr-btn">Button 2</button>
                        </div>
                        <nav role="navigation" class="fr-pagination fr-mt-8v" aria-label="Pagination">
                            <ul class="fr-pagination__list">
                                <li>
                                    <a class="fr-pagination__link fr-pagination__link--lg-label" id="pagination__link-309" href="" v-on:click.prevent="pagination=1">
                                        1
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-pagination__link" id="pagination__link-310" href="prevented" title="Page 1" v-on:click.prevent="pagination = 2">
                                        2
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-pagination__link fr-pagination__link--lg-label" id="pagination__link-317" href="/ici" v-on:click.prevent="pagination = 3">
                                        3
                                    </a>
                                </li>
                            </ul>
  ...
  const Link = { template: `<a href="#" id="btn-4" data-fr-analytics-click="libellé du lien envoyé à l'analytics">test</a>` };
  const Button = { template: `<button type="button" id="btn-5" class="fr-btn">Button page 3</button>` };
