    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div>
                ...
                <div class="fr-mb-6v">
                    <button type="button" class="fr-btn" data-fr-analytics-action="libellé envoyé à l'analytics" id="action-true">libellé du bouton</button>
                </div>
            </div>
            <div>
                <h4>action prévenue</h4>
                <div class="fr-mb-6v">
                    <button type="button" class="fr-btn" data-fr-analytics-action="false" id="action-false">libellé du bouton</button>
                </div>
            </div>
        </div>
    </div>
