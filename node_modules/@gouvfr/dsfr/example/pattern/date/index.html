...
<head>
    ...
    <title>Bloc fonctionnel de date unique - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Bloc fonctionnel de date unique (date)</h1>
        <p>Le champ de saisie de date fixe reprend trois champs de saisie de texte.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/blocs-fonctionnels/date-unique" rel="noopener external" target="_blank" title="${getBlankTitle('Documentation')}">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="date-628" aria-labelledby="date-628-legend date-628-messages">
                        <legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-628-legend">
                            Date de naissance
                        ...
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group" id="input-group-629">
                                <label class="fr-label" for="date-628-bday-day">
                                    Jour
                                    <span class="fr-hint-text">Exemple : 14</span>
                                </label>
                                <input class="fr-input" name="day" autocomplete="bday-day" id="date-628-bday-day" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group" id="input-group-630">
                                <label class="fr-label" for="date-628-bday-month">
                                    Mois
                                    <span class="fr-hint-text">Exemple : 12</span>
                                </label>
                                <input class="fr-input" name="month" autocomplete="bday-month" id="date-628-bday-month" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year">
                            <div class="fr-input-group" id="input-group-631">
                                <label class="fr-label" for="date-628-bday-year">
                                    Année
                                    <span class="fr-hint-text">Exemple : 1984</span>
                                </label>
                                <input class="fr-input" name="year" autocomplete="bday-year" id="date-628-bday-year" type="text">
                            </div>
                        </div>
                        <div class="fr-messages-group" id="date-628-messages" aria-live="polite">
                        </div>
                    </fieldset>
                </div>
            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-636">Extrait de code</button>
                            </h3>
                            <div id="snippet-636" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="date-632" aria-labelledby="date-632-legend date-632-messages"&gt;
...
&lt;/fieldset&gt;
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset fr-fieldset--error" id="date-error-637" role="group" aria-labelledby="date-error-637-legend date-error-637-messages">
                        <legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-error-637-legend">
                            Date de naissance
                            <span class="fr-hint-text">Indication : texte de description additionnel</span>
                        </legend>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group" id="input-group-638">
                                <label class="fr-label" for="date-error-637-bday-day">
                                    Jour
                                    <span class="fr-hint-text">Exemple : 14</span>
                                </label>
                                <input class="fr-input" name="day" value="00" autocomplete="bday-day" id="date-error-637-bday-day" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group" id="input-group-639">
                                <label class="fr-label" for="date-error-637-bday-month">
                                    Mois
                                    <span class="fr-hint-text">Exemple : 12</span>
                                </label>
                                <input class="fr-input" name="month" value="13" autocomplete="bday-month" id="date-error-637-bday-month" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year">
                            <div class="fr-input-group" id="input-group-640">
                                <label class="fr-label" for="date-error-637-bday-year">
                                    Année
                                    <span class="fr-hint-text">Exemple : 1984</span>
                                </label>
                                <input class="fr-input" name="year" value="1995e" autocomplete="bday-year" id="date-error-637-bday-year" type="text">
                            </div>
                        </div>
                        <div class="fr-messages-group" id="date-error-637-messages" aria-live="polite">
                            <p class="fr-message fr-message--error" id="date-error-637-message-error-1">Le jour est invalide</p>
                            <p class="fr-message fr-message--error" id="date-error-637-message-error-2">Le mois est invalide</p>
                            <p class="fr-message fr-message--error" id="date-error-637-message-error-3">L’année est invalide</p>
                        </div>
                    </fieldset>
                </div>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-645">Extrait de code</button>
                            </h3>
                            <div id="snippet-645" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="date-error-641" role="group" aria-labelledby="date-error-641-legend date-error-641-messages"&gt;
...
&lt;/fieldset&gt;
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset fr-fieldset--error" id="date-error-646" role="group" aria-labelledby="date-error-646-legend date-error-646-messages">
                        <legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="date-error-646-legend">
                            Date de naissance
                            <span class="fr-hint-text">Indication : texte de description additionnel</span>
                        </legend>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group" id="input-group-647">
                                <label class="fr-label" for="date-error-646-bday-day">
                                    Jour
                                    <span class="fr-hint-text">Exemple : 14</span>
                                </label>
                                <input class="fr-input" name="day" value="03" autocomplete="bday-day" id="date-error-646-bday-day" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
                            <div class="fr-input-group" id="input-group-648">
                                <label class="fr-label" for="date-error-646-bday-month">
                                    Mois
                                    <span class="fr-hint-text">Exemple : 12</span>
                                </label>
                                <input class="fr-input" name="month" value="03" autocomplete="bday-month" id="date-error-646-bday-month" type="text">
                            </div>
                        </div>
                        <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--inline-grow fr-fieldset__element--year">
                            <div class="fr-input-group" id="input-group-649">
                                <label class="fr-label" for="date-error-646-bday-year">
                                    Année
                                    <span class="fr-hint-text">Exemple : 1984</span>
                                </label>
                                <input class="fr-input" name="year" value="2525" autocomplete="bday-year" id="date-error-646-bday-year" type="text">
                            </div>
                        </div>
                        <div class="fr-messages-group" id="date-error-646-messages" aria-live="polite">
                            <p class="fr-message fr-message--error" id="date-error-646-message-error">La date est postérieure à aujourd’hui</p>
                        </div>
                    </fieldset>
                </div>
            </div>
            <div class="fr-grid-row fr-mb-6v">
                <div class="fr-col-12">
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-654">Extrait de code</button>
                            </h3>
                            <div id="snippet-654" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="date-error-650" role="group" aria-labelledby="date-error-650-legend date-error-650-messages"&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-655" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
