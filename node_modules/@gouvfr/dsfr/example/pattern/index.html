...
<head>
    ...
    <title>Bloc fonctionnel - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Bloc fonctionnel (pattern)</h1>
    </div>
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./address/'>Bloc fonctionnel d&#39;adresse postale (address)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./civility/'>Bloc fonctionnel de civilité (civility)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./date/'>Bloc fonctionnel de date unique (date)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./nationality/'>Bloc fonctionnel de nationalité (nationality)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./name/'>Bloc fonctionnel de nom et prénom (name)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./company/'>Bloc fonctionnel de société (company)</a>
            </li>
        </ul>
    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-524" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
