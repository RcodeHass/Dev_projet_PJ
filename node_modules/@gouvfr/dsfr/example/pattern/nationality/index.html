...
<head>
    ...
    <title>Bloc fonctionnel de nationalité - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Bloc fonctionnel de nationalité (nationality)</h1>
        ...
        <div class="fr-container">
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="nationality-657" aria-labelledby="nationality-657-legend nationality-657-messages">
                        <legend class="fr-sr-only" id="nationality-657-legend">
                            Nationalité
                        </legend>
                        <div class="fr-fieldset__element">
                            <div class="fr-select-group">
                                <label class="fr-label" for="nationality-select-656">
                                    Nationalité
                                </label>
                                <select class="fr-select" aria-describedby="nationality-select-656-messages" id="nationality-select-656" name="country">
                                ...
                                <div class="fr-messages-group" id="nationality-select-656-messages" aria-live="polite">
                                </div>
                            </div>
                        </div>
                        <div class="fr-messages-group" id="nationality-657-messages" aria-live="polite">
                        </div>
                    </fieldset>
                </div>
            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-660">Extrait de code</button>
                            </h3>
                            <div id="snippet-660" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="nationality-659" aria-labelledby="nationality-659-legend nationality-659-messages"&gt;
    &lt;legend class="fr-sr-only" id="nationality-659-legend"&gt;
        Nationalité
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-select-group"&gt;
            &lt;label class="fr-label" for="nationality-select-658"&gt;
                Nationalité
            &lt;/label&gt;
            &lt;select class="fr-select" aria-describedby="nationality-select-658-messages" id="nationality-select-658" name="country"&gt;
                &lt;option value="" selected disabled hidden&gt;Sélectionner une option&lt;/option&gt;
                &lt;option value="FR"&gt;Française&lt;/option&gt;
                &lt;option value="DE"&gt;Allemande&lt;/option&gt;
                &lt;option value="IT"&gt;Italienne&lt;/option&gt;
                &lt;option value="ES"&gt;Espagnole&lt;/option&gt;
            &lt;/select&gt;
            &lt;div class="fr-messages-group" id="nationality-select-658-messages" aria-live="polite"&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="nationality-659-messages" aria-live="polite"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-661" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
