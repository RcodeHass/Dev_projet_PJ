...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            ...
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/fondamentaux-techniques/pictogramme" rel="noopener external" target="_blank" title="${getBlankTitle(d.title)}"> Pictogramme</a>
            </li>
        </ul>
    </div>
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./colors/'>Utilitaires de couleur (colors)</a>
            </li>
            <li class="fr-mb-1w">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-10476" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
