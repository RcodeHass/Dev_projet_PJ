...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="background">Classes utilitaires de couleur de fond</a>
            </li>
            <li>
                <a href="border">Classes utilitaires de couleur de bordures</a>
            </li>
            <li>
                <a href="text">Classes utilitaires de couleur de texte</a>
            </li>
        </ul>
    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-10477" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
