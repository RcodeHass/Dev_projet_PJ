...
<head>
    ...
    <title>Système de design de l&#39;État - Système de design</title>
    ...
    <link href="../dist/dsfr.main.css" rel="stylesheet">
    <link href="../dist/utility/utility.legacy.css" rel="stylesheet">
    <link href="../dist/dsfr.legacy.css" rel="stylesheet">
    <link href="../dist/utility/utility.print.css" rel="stylesheet">
    <link href="../dist/dsfr.print.css" rel="stylesheet">
    <style>
        code[class*="language-"],
        pre[class*="language-"] {
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container">
        <ul class="fr-col-12">
            ...
            <li class="fr-mb-1w">
                <a href='./pattern/'>Bloc fonctionnel (pattern)</a>
            </li>
            <li class="fr-mb-1w">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
