...
<html lang="en">
  <head>
    ...
    <script>
      ...
      window.STORIES = [{"titlePrefix":"","directory":".","files":"*.mdx","importPathMatcher":"^\\.[\\\\/](?:(?!\\.)(?=.)[^/]*?\\.mdx)$"},{"titlePrefix":"","directory":"../src/dsfr","files":"**/*.mdx","importPathMatcher":"^(?:\\.\\.\\/src\\/dsfr(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.mdx)$"},{"titlePrefix":"","directory":"../src/dsfr","files":"**/*.stories.@(js|jsx|mjs|ts|tsx)","importPathMatcher":"^(?:\\.\\.\\/src\\/dsfr(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|mjs|ts|tsx))$"}];
...
<link rel="stylesheet" href="dist/dsfr.min.css">
<link rel="stylesheet" href="dist/utility/utility.min.css">
<script type="module" src="dist/dsfr.module.min.js"></script>

    <script type="module" crossorigin src="./assets/iframe-BIqFYiTT.js"></script>
  </head>
