import{e as q}from"./renderer-CAejfPdL.js";import"./_commonjsHelpers-BosuxZz1.js";const f=e=>q.render("logo",e),h={title:{control:"text",description:"Titre du logo (nom de l'entité)",type:{value:"string",required:!0}},size:{control:{type:"select"},description:"Taille du logo",options:["sm","md","lg"]}},c={title:"INTITULÉ <br>OFFICIEL",size:"md"},I=e=>({title:e.title||c.title,size:e.size||c.size}),C=e=>f({logo:I(e)}),O={id:"logo",title:"DSFR/Component/Logo",render:C,argTypes:h,args:c},r={args:{}},s={tags:["autodocs","!dev"],args:{size:"sm"}},o={tags:["autodocs","!dev"],args:{size:"md"}},t={tags:["autodocs","!dev"],args:{size:"lg"}},a={tags:["autodocs","!dev"],args:{title:"République <br>Française"}},n={tags:["autodocs","!dev"],args:{title:"Secrétaire d’État <br>chargé(e) de <br>l’égalité entre les <br>femmes et les <br>hommes et de la <br>lutte contre les <br>discriminations"}};var i,d,g;r.parameters={...r.parameters,docs:{...(i=r.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {}
