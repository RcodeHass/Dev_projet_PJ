import{e as C}from"./renderer-CAejfPdL.js";import"./_commonjsHelpers-BosuxZz1.js";const y=t=>C.render("content-media",t),x=`<!-- Les SVG porteurs de sens doivent avoir l'attribut role="img" et être labeliser par l'attribut aria-label="[A modifier - titre ou texte contenu dans l’image]" -->
<svg version="1.1" role="img" aria-label=”Gouvernement” xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
`,H={size:{control:{type:"select"},description:"Taille du contenu média",options:["sm","md","lg"]},caption:{control:"text",description:"Texte de description ou source",type:{value:"string"}},hasLink:{control:"boolean",description:"Ajoute un lien à la suite du texte de description"},linkLabel:{if:{arg:"hasLink",eq:!0},control:"text",description:"Libellé du lien",type:{value:"string"}},linkHref:{if:{arg:"hasLink",eq:!0},control:"text",description:"URL de destination du lien",type:{value:"string"}},type:{control:{type:"select"},description:"Type de contenu",options:["img","svg","video"]},imgRatio:{if:{arg:"type",eq:"img"},control:{type:"select"},description:"Ratio de l’image",options:["32x9","16x9","3x2","4x3","1x1","3x4","2x3"]},vidRatio:{if:{arg:"type",eq:"video"},control:{type:"select"},description:"Ratio de la vidéo",options:["16x9","4x3","1x1"]},img:{if:{arg:"type",eq:"img"},control:{type:"object"},description:"Image",table:{disable:!0}},svg:{if:{arg:"type",eq:"svg"},control:{type:"object"},description:"SVG",table:{disable:!0}},vid:{if:{arg:"type",eq:"video"},control:{type:"object"},description:"Vidéo",table:{disable:!0}}},c={size:"md",caption:"Description / Source",hasLink:!1,linkLabel:"Libellé du lien",linkHref:"#",type:"img",imgRatio:"16x9",vidRatio:"16x9",img:{src:"img/placeholder.16x9.png",alt:"unknown"},vid:{src:"https://www.youtube.com/embed/HyirpmPL43I",title:"[À MODIFIER - titre de la vidéo]",attributes:{allow:"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture",allowfullscreen:""}},svg:x},f=t=>{const n={size:t.size||c.size,caption:t.caption||c.caption};switch(t.hasLink&&(n.link={label:t.linkLabel||c.linkLabel,href:t.linkHref||c.linkHref}),t.type){case"img":n.img=t.img||c.img,n.img.ratio=t.imgRatio||c.imgRatio,n.img.classes=t.classes||c.classes;break;case"svg":n.svg=t.svg||c.svg;break;case"video":n.vid=t.vid||c.vid,n.vid.ratio=t.vidRatio||c.vidRatio;break}return n},L=t=>y({content:f(t)}),k={id:"content",title:"DSFR/Component/Content",render:L,argTypes:H,args:c},e={args:{}},l={tags:["autodocs","!dev"],args:{size:"sm"}},i={tags:["autodocs","!dev"],args:{size:"md"}},s={tags:["autodocs","!dev"],args:{size:"lg"}};var o,r,a;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {}
}`,...(a=(r=e.parameters)==null?void 0:r.docs)==null?void 0:a.source}}};var h,d,p;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    size: 'sm'
  }
}`,...(p=(d=l.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};var v,g,M;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    size: 'md'
  }
}`,...(M=(g=i.parameters)==null?void 0:g.docs)==null?void 0:M.source}}};var m,u,z;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    size: 'lg'
  }
}`,...(z=(u=s.parameters)==null?void 0:u.docs)==null?void 0:z.source}}};const V=["ContentStory","SizeSmStory","SizeMdStory","SizeLgStory"];export{e as ContentStory,s as SizeLgStory,i as SizeMdStory,l as SizeSmStory,V as __namedExportsOrder,k as default};
