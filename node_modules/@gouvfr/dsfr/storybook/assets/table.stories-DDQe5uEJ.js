import{e as J,u as o}from"./renderer-CAejfPdL.js";import"./_commonjsHelpers-BosuxZz1.js";const N=e=>J.render("table-wrapper",e),R=`
...
`,W='<span class="fr-sr-only">Sélectionner</span>',X=e=>`
...
`,r={caption:"Titre du tableau (caption)",noCaption:!1,captionBottom:!1,bordered:!1,noScroll:!1,hasHeader:!1,hasHeaderSegmented:!0,hasHeaderDetails:!0,hasHeaderButtons:!0,hasFooter:!1,hasFooterSelect:!0,hasFooterPagination:!0,hasFooterButtons:!0,size:"md",table:I()},oe=e=>{const t={size:e.size||r.size,table:{caption:e.caption||r.caption,captionDetail:e.captionDetail||r.captionDetail,thead:e.table.thead||r.table.thead,tbodies:e.table.tbodies||r.table.tbodies,id:e.id||void 0}};if(e.noCaption===!0&&(t.noCaption=e.noCaption),e.captionBottom===!0&&(t.captionBottom=e.captionBottom),e.bordered===!0&&(t.bordered=e.bordered),e.noScroll===!0&&(t.noScroll=e.noScroll),e.hasHeader===!0){let a="";e.hasHeaderSegmented===!0&&(a+=K),e.hasHeaderDetails===!0&&(a+=R),e.hasHeaderButtons===!0&&(a+=$),t.header=a}if(e.hasFooter===!0){let a="";e.hasFooterSelect===!0&&(a+=O),e.hasFooterPagination===!0&&(a+=U),e.hasFooterButtons===!0&&(a+=Q),t.footer=a}return t},re=e=>N({table:oe(e)}),ne={id:"table",title:"DSFR/Component/Table",render:re,argTypes:Y,args:r},n={tags:["autodocs"],args:{}},i={tags:["autodocs","!dev"],args:{id:o("table"),size:"sm"}},c={tags:["autodocs","!dev"],args:{id:o("table"),size:"lg"}},d={tags:["autodocs","!dev"],args:{id:o("table"),bordered:!0}},p={tags:["autodocs","!dev"],args:{id:o("table"),noScroll:!0}},u={tags:["autodocs","!dev"],args:{id:o("table"),table:Z()}},b={tags:["autodocs","!dev"],args:{id:o("table"),bordered:!0,captionDetail:ae(),table:ee()}},f={tags:["autodocs","!dev"],args:{id:o("table"),table:te()}};var h,x,v;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`{
  tags: ['autodocs'],
  args: {}
}`,...(v=(x=n.parameters)==null?void 0:x.docs)==null?void 0:v.source}}};var _,y,k;i.parameters={...i.parameters,docs:{...(_=i.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    size: 'sm'
  }
}`,...(k=(y=i.parameters)==null?void 0:y.docs)==null?void 0:k.source}}};var w,S,T;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    size: 'lg'
  }
}`,...(T=(S=c.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var q,A,L;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    bordered: true
  }
}`,...(L=(A=d.parameters)==null?void 0:A.docs)==null?void 0:L.source}}};var H,F,P;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    noScroll: true
  }
}`,...(P=(F=p.parameters)==null?void 0:F.docs)==null?void 0:P.source}}};var C,D,B;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    table: getSelectableTableArgs()
  }
}`,...(B=(D=u.parameters)==null?void 0:D.docs)==null?void 0:B.source}}};var j,z,G;b.parameters={...b.parameters,docs:{...(j=b.parameters)==null?void 0:j.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    bordered: true,
...
}`,...(G=(z=b.parameters)==null?void 0:z.docs)==null?void 0:G.source}}};var M,E,V;f.parameters={...f.parameters,docs:{...(M=f.parameters)==null?void 0:M.docs,source:{originalSource:`{
  tags: ['autodocs', '!dev'],
  args: {
    id: uniqueId('table'),
    table: getMiscellaneousTableArgs()
  }
}`,...(V=(E=f.parameters)==null?void 0:E.docs)==null?void 0:V.source}}};const ie=["TableStory","SizeSMStory","SizeLGStory","VerticalBordersStory","NoScrollStory","SelectableTableStory","ComplexTableStory","MiscellaneousTableStory"];export{b as ComplexTableStory,f as MiscellaneousTableStory,p as NoScrollStory,u as SelectableTableStory,c as SizeLGStory,i as SizeSMStory,n as TableStory,d as VerticalBordersStory,ie as __namedExportsOrder,ne as default};
